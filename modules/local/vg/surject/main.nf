process GAM_TO_TAGGED_SORTED_BAM {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'oras://community.wave.seqera.io/library/samtools_vg:ab1a9bfdf926c13f' :
        'community.wave.seqera.io/library/samtools_vg:0f04bc64e6413f22' }"
    ...
    else if  (params.multiple_references && meta.type == "modern" && meta.merged == false)	// User provided reference paths, GAM interleaved
        """
