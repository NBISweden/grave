...
workflow PIPELINE_INITIALISATION {
    ...
    """
    command = "nextflow run ${workflow.manifest.name} -profile <docker/singularity/.../institute> --input samplesheet.csv --outdir <OUTDIR>" //TODO modify the basic required command here (add steps, remove outdir...)
